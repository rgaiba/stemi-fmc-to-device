  ...
  return (
    <>
      <div className="hero">
        <div>
          ...
          <p className="hero-sub">
            ...
            <strong>Color</strong> = estimated drive time to nearest PCI-capable hospital. Right
            map shows the effect of adding <strong>Bayhealth Milford</strong>.
          </p>
        </div>
      ...
      <div className="footnote">
        ...
        <div>
          PCI CENTERS: CHRISTIANA CARE · BAYHEALTH KENT · BEEBE · TIDAL HEALTH MD · UM SHORE
          EASTON MD
        </div>
